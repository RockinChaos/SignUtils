...
## Report bugs using Github's [issues](https://github.com/RockinChaos/SignUtils/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/RockinChaos/SignUtils/issues/new/choose); it's that easy!
